...
/// </summary>
public class XmedChunk : Chunk
{
    public XmedChunk(DirectorFile? dir, ChunkType type) : base(dir, type)
    {
    }
    ...
    /// </summary>
    public CastMemberTextRead? Parsed { get; private set; }
    ...
    public override void Read(ReadStream stream)
    {
        ...
        try
        {
            Parsed = CastMemberTextRead.FromXmedChunk(Data, Dir);
        }
        catch (Exception ex)
        {
