        ...
        public void DumpSingleCastFile()
        {
            var files = new (string FileName, string Type)[] {
               ...
               // (TestContextHarness.GetTextAssetPath("MemberTypes/MemberImagePainted.cst"),"Bitmap"),
                ...
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Two_Behaviors_linked2.dir"),"Behavior"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Test_Vid1_WinMedia.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Test_Vid1_WinMedia_AudioOff.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Test_Vid1_WinMedia_LoopOff.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Test_Vid1_WinMedia_PausedOn.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Test_Vid1_WinMedia_VideoOff.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_DTS_Off.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PB_EveryFrame.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PB_EveryFrame_Fixed_14.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PB_EveryFrame_Maximum.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PB_Framing_Crop.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PB_Framing_Crop_Center.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_Preload.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_VideoOff.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_PausedOn.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_LoopOn.cst"),"Video"),
                //(TestContextHarness.GetTextAssetPath("MemberTypes/Vid_Avi_AudioOff.cst"),"Video"),
            };
