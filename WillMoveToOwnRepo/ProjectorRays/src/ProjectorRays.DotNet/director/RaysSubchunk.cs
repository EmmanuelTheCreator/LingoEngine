...
public class CastListEntry
{
    ...
    public void WriteJSON(RaysJSONWriter json)
    {
        json.StartObject();
...
public class KeyTableEntry
{
    ...
    {
        return $"KeyTableEntry: FourCC={Common.RaysUtil.FourCCToString(FourCC)}, ResourceID={ResourceID}, SectionID={SectionID}, CastID={CastID}";
    }
    public void WriteJSON(RaysJSONWriter json)
    {
        json.StartObject();
        json.WriteField("fourCC", Common.RaysUtil.FourCCToString(FourCC));
