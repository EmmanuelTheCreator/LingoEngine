...
namespace BlingoEngine.IO.Legacy.Texts
{
    public static class XmedExtensions
    {
        ...
        public static void ApplyStyleFlags(this XmedStyleDescriptor style, byte flags)
        {
        ...
        public static void ApplyAlignmentFlags(this XmedStyleDescriptor style, byte flags)
        {
