...
namespace LingoEngine.Pictures
{
    ...
    public class LingoMemberBitmap : LingoMember
    {
        ...
        /// <summary>
        /// Gets the framework object that implements the <see cref="ILingoFrameworkMemberBitmap"/> interface.
        /// </summary>
        /// <typeparam name="T">The type of the framework object.</typeparam>
        /// <returns>Framework object implementing <see cref="ILingoFrameworkMemberBitmap"/>.</returns>
        public T Framework<T>() where T : class, ILingoFrameworkMemberBitmap => (T)_lingoFrameworkMemberPicture;
        ...
        /// <summary>
        /// Preloads the picture into memory using <see cref="ILingoFrameworkMemberBitmap.Preload"/>.
        ...
        /// <summary>
        /// Erases the picture using <see cref="ILingoFrameworkMemberBitmap.Erase"/>.
