...
namespace BlingoEngine.Director.Core.Stages
{
        ...
        IAbstCommandHandler<RotateSpritesCommand>
    {
        ...
        public DirectorStageWindow(IServiceProvider serviceProvider, IHistoryManager historyManager, IBlingoFrameworkFactory factory, IAbstCommandManager commandManager, IBlingoPlayer player, IDirectorEventMediator mediator, IDirStageManager stageManager) : base(serviceProvider, DirectorMenuCodes.StageWindow)
        {
            _player = player;
