...
/// </summary>
public sealed class PacManEventSubscription
{
    private bool _released;
    private readonly Action _release;

    internal PacManEventSubscription(Action release)
    {
...
internal sealed class PacManEventMediator<T>
{
    ...
    /// </summary>
    public PacManEventSubscription Subscribe(Action<T> handler)
    {
        if (handler is null)
        {
        ...
        return new PacManEventSubscription(() =>
        {
