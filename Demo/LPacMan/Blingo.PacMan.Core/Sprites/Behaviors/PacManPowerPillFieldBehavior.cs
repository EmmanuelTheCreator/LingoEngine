...
internal sealed class PacManPowerPillFieldBehavior : BlingoSpriteBehavior, IHasBeginSpriteEvent, IHasEndSpriteEvent
{
    ...
    public PacManPowerPillFieldBehavior(IBlingoMovieEnvironment env, GlobalVars globals)
        : base(env)
    {
    ...
    private void CreateConsumableSprite(Tile tile, PacManGameBehavior coordinator)
    {
        ...
        var behavior = sprite.SetBehavior<PacManPowerPillBehavior>();
